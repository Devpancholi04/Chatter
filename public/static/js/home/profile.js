...
function showSetting(option) {
    ...
    if (option === 'deactivate') {
        ...
        <div class="setting-box">
          ...
          <button class="btn-primary" onclick="alert('Deactivation request sent')">Proceed</button>
        </div>
      `;
        ...
        <div class="setting-box">
          ...
          <button class="btn-primary" onclick="alert('Password changed successfully')">Update</button>
        </div>
      `;
    } else if (option === '2fa') {
        content.innerHTML = `
